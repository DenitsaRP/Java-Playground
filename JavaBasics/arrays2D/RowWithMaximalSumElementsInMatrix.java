...
//Write a program that finds the row - in entered form the user matrix m x n,
//where the sum of the elements is maximal.

public class RowWithMaximalSumElementsInMatrix {
