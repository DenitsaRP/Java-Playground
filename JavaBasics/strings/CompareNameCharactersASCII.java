...
//Write a program that enters the three names of two people separated by a comma from the console. 
//Print on screen whose name has larger sum of the component name characters according to ASCII code table.
